/**
 * Unit cube mesh data for browser example
 *
 * Cube vertices in [0,1]^3 with 6-tetrahedra decomposition
...
/** 8 vertices of the unit cube [0,1]^3 */
...
export const cubeTetrahedra = new Int32Array([
  1, 2, 3, 7, // T1: bottom-right face
  1, 3, 4, 7, // T2: bottom-back face
  1, 4, 8, 7, // T3: back-left face
  1, 8, 5, 7, // T4: top-left face
  1, 5, 6, 7, // T5: top-front face
  1, 6, 2, 7, // T6: front-right face
]);
